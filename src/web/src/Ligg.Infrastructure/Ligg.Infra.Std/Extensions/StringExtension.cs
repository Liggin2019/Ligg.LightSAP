...
namespace Ligg.Infrastructure.Extensions
{
    public static partial class StringExtension
    {
        ...
        public static readonly Regex AlphaNumeralHyphenAndUnderscoreExpression = new Regex("^[A-Za-z0-9_\\-]+$");
        public static readonly Regex AlphaNumeralAndUnderscoreExpression = new Regex("^[A-Za-z0-9_]+$");
